...
public class ElementPedagogique {
    ...
    @OneToOne(cascade = CascadeType.ALL, targetEntity = Enseignant.class)
    ...
    @OneToOne(cascade = CascadeType.ALL, targetEntity = TypeElement.class)
    @JoinColumn(name = "id_element_typeElement")
    private TypeElement typeElement;

    @OneToOne(cascade = CascadeType.ALL, targetEntity = Niveau.class)
